...
-   **For videos** and descriptions of issues that impact people who are elderly and people with disabilities, see [Web Accessibility Perspectives]({{ "/perspectives/" | relative_url }}). These videos include older users: [Customizable Text]({{ "/perspectives/customizable" | relative_url }}), [Colors with Good Contrast]({{ "/perspectives/contrast" | relative_url }}), [Notifications and Feedback]({{ "/perspectives/notifications" | relative_url }}), [Understandable Content]({{ "/perspectives/understandable" | relative_url }}), and [Large Links, Buttons, and Controls.]({{ "/perspectives/controls" | relative_url }})
